// Insurance Premium Calculation Data (multiplied by 1.15)
const premiumRates = {
    'Emerald': {
        '0-17': 959 * 1.15, '18-24': 1490 * 1.15, '25-29': 1851 * 1.15, '30-34': 1992 * 1.15, 
        '35-39': 2175 * 1.15, '40-44': 2527 * 1.15, '45-49': 2886 * 1.15, '50-54': 3230 * 1.15, 
        '55-59': 4218 * 1.15, '60-64': 5323 * 1.15, '65-69': 7127 * 1.15, '70-74': 9321 * 1.15, 
        '75-79': 10954 * 1.15, '80+': 12139 * 1.15
    },
    'Sapphire': {
        '0-17': 1059 * 1.15, '18-24': 1645 * 1.15, '25-29': 2046 * 1.15, '30-34': 2200 * 1.15, 
        '35-39': 2405 * 1.15, '40-44': 2793 * 1.15, '45-49': 3189 * 1.15, '50-54': 3569 * 1.15, 
        '55-59': 4662 * 1.15, '60-64': 5883 * 1.15, '65-69': 8076 * 1.15, '70-74': 10758 * 1.15, 
        '75-79': 12755 * 1.15, '80+': 14202 * 1.15
    },
    'Ruby': {
        '0-17': 1721 * 1.15, '18-24': 2573 * 1.15, '25-29': 3170 * 1.15, '30-34': 3346 * 1.15, 
        '35-39': 3739 * 1.15, '40-44': 4275 * 1.15, '45-49': 4925 * 1.15, '50-54': 5480 * 1.15, 
        '55-59': 6834 * 1.15, '60-64': 8710 * 1.15, '65-69': 11646 * 1.15, '70-74': 15519 * 1.15, 
        '75-79': 18342 * 1.15, '80+': 20424 * 1.15
    },
    'Jade': {
        '0-17': 2271 * 1.15, '18-24': 3283 * 1.15, '25-29': 3939 * 1.15, '30-34': 4276 * 1.15, 
        '35-39': 4679 * 1.15, '40-44': 5376 * 1.15, '45-49': 5991 * 1.15, '50-54': 6813 * 1.15, 
        '55-59': 8557 * 1.15, '60-64': 11340 * 1.15, '65-69': 15164 * 1.15, '70-74': 20109 * 1.15, 
        '75-79': 23659 * 1.15, '80+': 26341 * 1.15
    },
    'Diamond': {
        '0-17': 2493 * 1.15, '18-24': 3604 * 1.15, '25-29': 4325 * 1.15, '30-34': 4693 * 1.15, 
        '35-39': 5136 * 1.15, '40-44': 5901 * 1.15, '45-49': 6578 * 1.15, '50-54': 7478 * 1.15, 
        '55-59': 9393 * 1.15, '60-64': 12449 * 1.15, '65-69': 16645 * 1.15, '70-74': 22074 * 1.15, 
        '75-79': 25971 * 1.15, '80+': 28917 * 1.15
    }
};
...
const calculatePremium = () => {
    ...
    const areaMultipliers = {
        ...
        'Worldwide Excluding USA': 1.0,  // Corrected value
        'Asia': 0.88,
    ...
    // Display the calculated premium and breakdown
    document.getElementById("quote").innerText = `Your estimated premium is $${adjustedPremium.toFixed(2)}`;
    document.getElementById("breakdown").innerHTML = breakdownSteps.map(step => `<li>${step}</li>`).join('');
};

// Add an event listener for the button click to calculate premium
document.getElementById("calculate").addEventListener('click', calculatePremium);
